...
public class ModoEducativo extends Application {
    ...
    private String[] explanations = {
            ...
            "En cada nuevo mes, la cantidad de conejos actuales dará a luz a la cantidad de conejos que habia el mes anterior.",
    ...
    public void start(Stage primaryStage) {
        ...
        fila.getChildren().add(imageView); // Agregar la imagen al HBox
        ...
        botones.getChildren().addAll(nextButton, salirButton, jugarButton);
